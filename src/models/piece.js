...
import PIECE_WRAPPER_SRC from "../images/wrap.png";
...
function getPositionXY(position) {
  ...
  result.y =
    databus.contentPaddingTop + Math.floor(position / databus.stage) * width;
  return result;
}
...
export default class Piece {
  ...
  render(ctx) {
    ...
    ctx.drawImage(this.wrapperImg, this.x, this.y, this.width, this.height);
  }
  // 每一帧更新子弹位置
  // update() {
