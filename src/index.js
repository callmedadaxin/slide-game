...
import DataBus, { ratio } from "./databus";
import "./index.css";
...
class Main {
  constructor() {
    canvas.width = databus.screenWidth * ratio;
    canvas.height = databus.screenHeight * ratio;
    canvas.style.width = databus.screenWidth + "px";
    canvas.style.height = databus.screenHeight + "px";
  ...
  movePieces(direction) {
    ...
    switch (direction) {
      ...
      case "left":
        ...
        if (
          Math.floor(targetPiece / databus.stage) !==
          Math.floor(databus.emptyPosition / databus.stage)
        ) {
